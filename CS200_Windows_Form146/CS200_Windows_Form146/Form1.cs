...
namespace CS200_Windows_Form146
{
    public partial class Form1 : Form
    {
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            {
                pictureBox1.Image = Bitmap.FromFile(@"C:\Users\진시영\source\repos\CS200_Windows_Form146\CS200_Windows_Form146\..\Image\Anne.jfif");
                txtMemo.Text = "앤 여왕은 1702년 3월 8일 잉글랜드와 스코틀랜드...";
            }
            else if(e.Node.Text =="조지 1세(1714~1727)")
            {
                pictureBox1.Image = Bitmap.FromFile(@"C:\Users\진시영\source\repos\CS200_Windows_Form146\CS200_Windows_Form146\..\Image\King_George.jpg");
